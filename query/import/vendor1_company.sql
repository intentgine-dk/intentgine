SELECT
    ...
    END as phone_number
    ,ntw.company_city_headquarters as city
    ,ntw.company_state_headquarters as state
    ,ntw.company_country_headquarters as country
    ,loc.location_id as location_id
    ,ntw.company_employees_bucket as employee_size
    ,emp_size.employee_size_id as employee_size_id
    ,ntw.company_normalized_industry as industry
    ,ind.industry_id as industry_id
    ,ntw.company_primary_industry as subindustry
...
FROM
    ig_vendor.dv01wn_q4_refresh ntw
