...
set company_linkedin_url = 'https://www.' + lower(trim(t2.company_linkedin_url))
from {0} as t2
where
	...
	and lower(trim(t1.email_domain)) = lower(trim(replace(replace(replace(t2.domain, 'https://', ''), 'http://', ''), 'www.', '')));